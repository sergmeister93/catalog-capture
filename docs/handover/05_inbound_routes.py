...
# --- Path setup ---------------------------------------------------------------
# This file lives at backend/src/service_photo/api/inbound_routes.py.
# parents[0]=api, [1]=service_photo, [2]=src, [3]=backend, [4]=repo root.
REPO_ROOT = Path(__file__).resolve().parents[4]
INBOUND_DIR = REPO_ROOT / "inbound"
INPUT_IMAGES_DIR = REPO_ROOT / "input_images"
