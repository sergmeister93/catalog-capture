-- Service Photo POC — Initial PostgreSQL Migration
-- Phase 1 schema: all 12 core tables
-- See docs/04_initial_migration.md for full documentation and implementation notes.
